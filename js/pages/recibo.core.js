...
/* ===============================
   COMPROBANTE — VISTA RECIBO (LIMPIO Y HUMANO)
================================ */

if (window.IS_READ_ONLY && typeof pedido === "object") {

  // 🧹 Eliminar cualquier rastro de checkout
...
/* =========================================================
   FIN cargarPedidoExistente
========================================================= */
}; // ✅ ESTE CIERRE FALTABA

/* =========================================================
   AUTO INIT (FUERA DE TODO)
========================================================= */
if (window.ORDER_ID) {
